...
const vec3 red = vec3(127.0/255.0, 43.0/255.0, 56.0/255.0);
...
void main()
{
    ...
    float colhue = atan2(oklabcol.b, oklabcol.g);
    float colC = sqrt(oklabcol.b*oklabcol.b + oklabcol.g * oklabcol.g);
    float redhue = atan2(labred.b, labred.g);
    float redC = sqrt(labred.g * labred.g + labred.b * labred.b);
    oklabcol.r = pow(colhue-redhue, 4)/2.5;
