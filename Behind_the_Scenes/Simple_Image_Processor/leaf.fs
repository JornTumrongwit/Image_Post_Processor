...
void main()
{
    ...
    oklabcol.r = floor((oklabcol.r) * 32.0 * distance(labgreen, oklabcol)*3.5)/ (32.0);
    oklabcol.g = mix(labgreen.g, labbrown.g, 2.0*oklabcol.r-1.0);
    oklabcol.b = mix(labgreen.b, labbrown.b, 2.0*oklabcol.r-1.0);
